...
function updateGradient()
{
    ...
    $('#banner').css({
        background: "-webkit-linear-gradient(top, "+color1+" 0%, "+color2+" 100%)"}).css({
        background: "-moz-linear-gradient(top, "+color1+" 0%, "+color2+" 100%)"}).css({
        background: "-ms-linear-gradient(top, "+color1+" 0%, "+color2+" 100%)"}).css({
        background: "-o-linear-gradient(top, "+color1+" 0%, "+color2+" 100%)"}).css({
